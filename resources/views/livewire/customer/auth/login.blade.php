                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <img src="{{ asset('assets/logo.png') }}" alt="logo"
                            class="object-fit-contain shadow-sm rounded mb-3" style="width:100px;height:100px;">
                    ...
                    <form wire:submit='login' method="POST">
                        ...
                        <p class="text-end mb-4">
                            <a wire:navigate type="button" data-bs-toggle="modal" data-bs-target="#forgotPass"
                        ...
                        <p class="text-center fw-semibold">Don't have an account? <a wire:navigate
                                href="{{ route('customer.signUp') }}" class="text-success"
