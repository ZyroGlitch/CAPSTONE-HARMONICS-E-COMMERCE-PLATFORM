            ...
            <form wire:submit='store' method="post">
                ...
                <div class="d-flex gap-5 mb-5">
                    ...
                    <div>
                        ...
                        <input wire:model='quantity' type="number" class="form-control shadow-sm" min="1"
                ...
                <div class="d-flex align-items-center gap-3">
                    <button class="btn btn-outline-success btn-lg rounded-pill shadow-sm " style="width:180px;"><i
                            class="bi bi-cart-check me-2"></i> Add to
                        Cart</button>

                    <button type="submit" class="btn btn-success btn-lg rounded-pill shadow-sm"
                        style="width:180px;">Buy
                        Now</button>
                </div>
            </form>
        </div>
