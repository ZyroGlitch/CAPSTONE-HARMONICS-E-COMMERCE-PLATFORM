<div>
    <div class="wrapper">
        ...
        <nav id="sidebar" class="shadow-sm" style="background:#FEFEFF">
            <div class="sidebar-header d-flex align-items-center p-3">
                <img src="{{ asset('assets/logo.png') }}" alt="LOGO"
                    class="object-contain text-center rounded-pill shadow-sm me-2" style="width:50px;height:50px;">
            ...
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-dashboard') }}"
                    class="nav-button @if (request()->is('admin-dashboard')) current @endif"><i
                        class="fa-solid fa-chart-pie me-2"></i>
                    <span>Dashboard</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-orders') }}"
                    class="nav-button @if (request()->is('admin-orders')) current @endif"><i
                        class="fa-solid fa-cart-shopping me-2"></i>
                    <span>Orders</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-product') }}"
                    class="nav-button @if (request()->is('admin-product')) current @endif"><i
                        class="fa-solid fa-bag-shopping me-2"></i>
                    <span>Product</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-salesReport') }}"
                    class="nav-button @if (request()->is('admin-salesReport')) current @endif"><i
                        class="fa-solid fa-chart-line me-2"></i>
                    <span>Sales Report</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-customers') }}"
                    class="nav-button @if (request()->is('admin-customers')) current @endif"><i
                        class="fa-solid fa-users me-2"></i>
                    <span>Customers</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-messages') }}"
                    class="nav-button @if (request()->is('admin-messages')) current @endif"><i
                        class="fa-solid fa-comment-dots me-2"></i>
                    <span>Messages</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('admin.admin-profile') }}"
                    class="nav-button @if (request()->is('admin-profile')) current @endif"><i
                        class="fa-solid fa-circle-user me-2"></i>
                    <span>Profile</span></a>
            </li>
            <li class="d-flex justify-content-start align-items-center p-3" style="height:50px;">
                <a wire:navigate href="{{ route('customer.logout') }}"
                    class="nav-button @if (request()->is('logout')) current @endif"><i
        ...
        <div id="content">
            ...
            <!-- Content Section -->
            <div class="container-fluid bg-light h-auto p-4">
                @yield('page-content')
            </div>
        </div>
    </div>
                ...
                <div class="card shadow-sm mb-2">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <img src="assets/photo.png" alt="image"
                            class="object-fit-contain rounded-pill shadow-sm me-3" style="width:60px;height:60px;">
